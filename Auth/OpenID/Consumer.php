...
class Auth_OpenID_GenericConsumer {
    ...
    function _verifyDiscoveryResultsOpenID1($message, $endpoint)
    {
        ...
        if ($endpoint !== null) {
            ...
            if (instanceof($result, 'Auth_OpenID_TypeURIMismatch')) {
    ...
    function _checkAuth($message, $server_url)
    {
        ...
        if (($resp_message === null) ||
            (instanceof($resp_message, 'Auth_OpenID_ServerErrorContainer'))) {
            return false;
        }
    ...
    function _negotiateAssociation($endpoint)
    {
        ...
        if (instanceof($assoc, 'Auth_OpenID_ServerErrorContainer')) {
            $why = $assoc;
    ...
    function _requestAssociation($endpoint, $assoc_type, $session_type)
    {
        ...
        if ($response_message === null) {
            ...
            return null;
        } else if (instanceof($response_message,
